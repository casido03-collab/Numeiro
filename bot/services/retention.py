...
RETENTION_PUSHES = [
    # Push #1
    "🔮 {name}, сегодня твои энергии особенно нестабильны…\n"
    "Луна усиливает внутренние переживания, а это значит — ближайшие дни могут принести неожиданные разговоры и решения.\n"
    "Возможно именно сейчас тебе нужен взгляд со стороны.\n"
    "Задай любой вопрос Aisha — отношения, деньги, будущее: 👉 /start",

    # Push #2
    "🌙 {name}, некоторые знаки появляются в жизни не случайно.\n"
    "Твоя энергетика на этой неделе указывает на важные перемены, связанные с человеком, о котором ты думаешь чаще обычного.\n"
    "Иногда судьба начинает менять всё постепенно.\n"
    "Спроси у Aisha то, что давно волнует: 👉 /start",

    # Push #3
    "✨ {name}, твоя интуиция сейчас сильнее чем обычно.\n"
    "Астрологические линии показывают период внутренних изменений и переоценки событий вокруг тебя.\n"
    "Возможно ответы уже совсем рядом.\n"
    "Задай вопрос Aisha: 👉 /start",

    # Push #4
    "🔮 {name}, ближайшие дни могут стать для тебя переломными.\n"
    "Некоторые энергии вокруг тебя начали меняться, особенно в сфере отношений и общения.\n"
    "Лучше узнать заранее, к чему это приведёт.\n"
    "Спроси у Aisha о своей ситуации: 👉 /start",
    ...
    # Push #6
    "💫 {name}, твои числа судьбы сейчас активны как никогда.\n"
    "Есть вероятность неожиданной встречи или разговора, который изменит твой взгляд на ситуацию.\n"
    ...
    "Некоторые решения, которые ты откладывал, скоро снова напомнят о себе.\n"
    "Aisha поможет разобраться в ситуации: 👉 /start",

    # Push #9
    "✨ {name}, твоя натальная энергия сейчас проходит фазу обновления.\n"
    "Это может отражаться на отношениях, настроении и даже случайных совпадениях вокруг.\n"
    "Хочешь посмотреть глубже?\n"
    "👉 /start",

    # Push #10
    "🔮 {name}, иногда судьба начинает подавать знаки ещё до событий.\n"
    "Сегодня именно такой день.\n"
    "Спроси у Aisha всё что волнует: 👉 /start",

    # Push #11
    "🌌 {name}, последние дни твоя энергетика изменилась сильнее обычного.\n"
    "Особенно это касается сферы общения и личной жизни.\n"
    "Возможно пора взглянуть на ситуацию иначе.\n"
    "👉 /start",

    # Push #12
    "💫 {name}, сейчас вокруг тебя формируется новый жизненный цикл.\n"
    "Некоторые события уже начинают двигаться в неожиданную сторону.\n"
    "Узнай что ждёт тебя дальше: 👉 /start",

    # Push #13
    "🌙 {name}, твоя интуиция пытается обратить внимание на что-то важное.\n"
    ...
    "Возможно внутри тебя давно есть вопрос, который не даёт покоя.\n"
    ...
    "Хочешь узнать, что ждёт впереди?\n"
    "👉 /start",

    # Push #16
    "🌌 {name}, иногда люди возвращаются к ответам именно тогда, когда готовы их услышать.\n"
    "Возможно этот момент настал и для тебя.\n"
    "👉 /start",

    # Push #17
    "💫 {name}, твоя энергия сейчас особенно восприимчива к влиянию окружающих людей.\n"
    "Это может изменить планы и внутреннее состояние.\n"
    "Разберём подробнее? 👉 /start",

    # Push #18
    "🔮 {name}, карты показывают сильное влияние прошлого на твои нынешние решения.\n"
    "Иногда важно понять причину происходящего.\n"
    "Спроси у Aisha: 👉 /start",

    # Push #19
    "🌙 {name}, сегодняшний день может стать важной точкой для новых решений.\n"
    "Некоторые события уже начали складываться вокруг тебя.\n"
    "👉 /start",
    ...
    # Push #21
    "🔮 {name}, энергия вокруг тебя становится всё более переменчивой.\n"
    "Это может повлиять на отношения, финансы и внутреннее состояние.\n"
    "Узнай что ждёт впереди: 👉 /start",

    # Push #22
    "🌌 {name}, некоторые люди появляются в жизни не случайно.\n"
    "И сейчас твои линии судьбы особенно связаны с темой отношений.\n"
    "👉 /start",

    # Push #23
    "💫 {name}, твоя неделя может пройти совсем иначе, если заранее увидеть важные знаки.\n"
    ...
    "Особенно с человеком, о котором ты думаешь чаще остальных.\n"
    "👉 /start",

    # Push #26
    "✨ {name}, твои внутренние ощущения сейчас могут оказаться точнее любых советов.\n"
    ...
    # Push #29
    "🌙 {name}, твоя энергия сейчас находится между прошлым и новым этапом.\n"
    "Возможно впереди уже начинается что-то значимое.\n"
    "👉 /start",

    # Push #30
    "🔮 {name}, Aisha снова готова посмотреть твои линии судьбы и раскрыть скрытые влияния этой недели.\n"
    "👉 /start",
]
