...
_UPSELL_BRIDGES = {
    ...
    "t990": [
        "Причина найдена {e}\n\nТеперь я обращусь к картам Таро — они дадут прямой ответ именно на ваш вопрос, конкретно и без общих слов.",
        "После разбора причины — время узнать что ждёт впереди {e}\n\nЯ раскладываю карты Таро — одна карта скажет больше, чем долгий разговор.",
        "Теперь, когда причина ясна — карты Таро покажут путь {e}\n\nЭто будет прямой ответ на ваш вопрос, а не общие слова.",
    ],
    "t1990": [
