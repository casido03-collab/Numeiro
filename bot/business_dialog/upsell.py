...
_UPSELL_BRIDGES = {
    ...
    "t990": [
        "Причина найдена {e}\n\nТеперь я обращусь к картам Таро — они помогут увидеть вашу ситуацию точнее и подскажут, куда она движется.",
        "После разбора причины — карты Таро дадут более глубокий взгляд {e}\n\nОни уточнят картину и покажут, на что стоит обратить внимание.",
        "Теперь, когда причина ясна — карты помогут конкретизировать ситуацию {e}\n\nЭто другой уровень — не общие слова, а образ того, что происходит.",
    ],
    "t1990": [
