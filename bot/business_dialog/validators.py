...
_NON_NAME_WORDS = {
    ...
    "когда", "почему", "зачем", "где", "куда", "откуда", "чем",
    "который", "которая", "которое", "которые",
    # Глаголы и служебные слова начала предложения
    "будет", "будем", "будут", "есть", "нет", "хочу", "хочет",
    "если", "хотелось", "смогу", "смогла", "смогут",
    "доброй", "добрый", "доброе", "добрые",
    # Другие частые первые слова не-имён
    "выйду", "выйдет", "найду", "найдет",
}
