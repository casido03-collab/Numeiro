...
async def _process_payment(
    ...
    if is_accompaniment(tier_key):
        # Сопровождение — объясняем формат, затем переводим в стадию
        if tier_key == "t1990":
            await _send(
                "Я рядом, душа моя 🌟\n\n"
                "Каждое утро в 8 часов буду присылать вам личное послание — "
                "план на день, на что обратить внимание.\n\n"
                "В течение дня пишите мне — до 6 вопросов в день. "
                "По ситуации, по чувствам, по любому моменту. Я здесь 🌙"
            )
        else:
            await _send(
