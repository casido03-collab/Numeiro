...
def _welcome_text(name: str | None) -> str:
    ...
    return (
        f"{greeting}"
        f"✨ Добро пожаловать в *Aisha AI* — твой персональный эзотерический AI‑компаньон.\n\n"
        f"Здесь тебя ждёт:\n\n"
        f"🔮 *Мой разбор* — нумерологический анализ по дате рождения\n"
        ...
        f"🔮 *Вопрос Тарологу* — личный вопрос судьбе\n"
        f"⚡ *Энергия дня* — ежедневный прогноз\n\n"
        f"Всё основано на нумерологии, матрице судьбы и AI‑интерпретации.\n\n"
        f"_Выбери, с чего начать:_"
    )

# ─── Dynamic headers ──────────────────────────────────────────────────────────

_HEADERS_WITH_NAME = [
    "✨ {name}, некоторые ответы уже ждут тебя.",
    "🌙 {name}, сегодня интуиция может быть особенно сильной.",
    "🔮 {name}, выбери направление которое сейчас откликается сильнее всего.",
    "✨ {name}, иногда один вопрос меняет взгляд на ситуацию.",
    "🌌 {name}, некоторые совпадения не случайны.",
    "❤️ {name}, возможно именно сейчас ты ищешь важный ответ.",
    "🌙 {name}, сегодня особенно важны внутренние ощущения.",
    "✨ {name}, твоё персональное пространство готово.",
    "🔮 {name}, с чего начнём сегодня?",
    "🌙 {name}, выбери то что волнует тебя сейчас больше всего.",
]
...
Твой текущий тариф: *{current_plan}*
